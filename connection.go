...
// Connection is the interface for network connections.
// ServerConnection and ClientConnection both implement it.
...
func NewServerConn(netid int64, server *TCPServer, conn net.Conn) Connection {
